...
class Robot:
    ...
    telemetry = Telemetry(
        ...
        target_yaw=0,
        heading=0,
        drive_vector_x = Pathing.goal_vector_x,
        drive_vector_y = Pathing.goal_vector_y,
        obstacle_vector_x = Pathing.obstacle_vector_x,
        obstacle_vector_y = Pathing.obstacle_vector_y,
        edge_vector_x=Pathing.edge_vector_x,
        edge_vector_y=Pathing.edge_vector_y,
